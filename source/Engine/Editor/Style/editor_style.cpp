...
namespace NexAur::EditorStyle {
    ...
    void applyTheme() {
        ...
        colors[ImGuiCol_PopupBg] = EditorThemeTokens::withAlpha(palette.background_panel, 0.99f);
        colors[ImGuiCol_Border] = EditorThemeTokens::withAlpha(palette.border_subtle, 0.78f);
        colors[ImGuiCol_BorderShadow] = EditorThemeTokens::withAlpha(palette.background_main, 0.0f);
        colors[ImGuiCol_FrameBg] = palette.background_input;
        colors[ImGuiCol_FrameBgHovered] = EditorThemeTokens::withAlpha(palette.header_hovered, 0.72f);
        colors[ImGuiCol_FrameBgActive] = EditorThemeTokens::withAlpha(palette.header_active, 0.86f);
        ...
        colors[ImGuiCol_ScrollbarBg] = palette.background_main;
        ...
        colors[ImGuiCol_SliderGrab] = EditorThemeTokens::withAlpha(palette.accent_blue, 0.78f);
        ...
        colors[ImGuiCol_SeparatorHovered] = EditorThemeTokens::withAlpha(palette.accent_blue, 0.48f);
        colors[ImGuiCol_SeparatorActive] = EditorThemeTokens::withAlpha(palette.accent_cyan, 0.72f);
        colors[ImGuiCol_ResizeGrip] = EditorThemeTokens::withAlpha(palette.accent_blue, 0.18f);
        colors[ImGuiCol_ResizeGripHovered] = EditorThemeTokens::withAlpha(palette.accent_blue, 0.38f);
        colors[ImGuiCol_ResizeGripActive] = EditorThemeTokens::withAlpha(palette.accent_cyan, 0.62f);
        colors[ImGuiCol_Tab] = palette.background_panel;
        colors[ImGuiCol_TabHovered] = EditorThemeTokens::withAlpha(palette.header_hovered, 0.86f);
        colors[ImGuiCol_TabActive] = palette.header;
        colors[ImGuiCol_TabUnfocused] = palette.background_main;
        colors[ImGuiCol_TabUnfocusedActive] = palette.background_panel_light;
        colors[ImGuiCol_DockingPreview] = EditorThemeTokens::withAlpha(palette.accent_blue, 0.34f);
        ...
        colors[ImGuiCol_TableHeaderBg] = palette.background_panel_light;
        colors[ImGuiCol_TableBorderStrong] = palette.border_subtle;
        colors[ImGuiCol_TableBorderLight] = EditorThemeTokens::withAlpha(palette.border_subtle, 0.48f);
        colors[ImGuiCol_TableRowBg] = EditorThemeTokens::withAlpha(palette.background_main, 0.0f);
        colors[ImGuiCol_TableRowBgAlt] = EditorThemeTokens::withAlpha(palette.text_primary, 0.024f);
        colors[ImGuiCol_TextSelectedBg] = EditorThemeTokens::withAlpha(palette.accent_blue, 0.30f);
        colors[ImGuiCol_DragDropTarget] = EditorThemeTokens::withAlpha(palette.accent_cyan, 0.70f);
        colors[ImGuiCol_NavHighlight] = EditorThemeTokens::withAlpha(palette.accent_blue, 0.54f);
