    ...
    namespace {
        ...
        VulkanDescriptorSetLayoutDesc frameGlobalDescriptorLayoutDesc() {
            ...
            desc.bindings = {
                ...
                { 6, VK_DESCRIPTOR_TYPE_STORAGE_BUFFER, 1, VK_SHADER_STAGE_FRAGMENT_BIT },
                { 7, VK_DESCRIPTOR_TYPE_SAMPLED_IMAGE, 1, VK_SHADER_STAGE_FRAGMENT_BIT },
                { 8, VK_DESCRIPTOR_TYPE_SAMPLER, 1, VK_SHADER_STAGE_FRAGMENT_BIT }
            };
            return desc;
        ...
        VulkanDescriptorSetLayoutDesc postProcessInputDescriptorLayoutDesc() {
            VulkanDescriptorSetLayoutDesc desc;
            desc.bindings = {
                ...
                { 8, VK_DESCRIPTOR_TYPE_SAMPLED_IMAGE, 1, VK_SHADER_STAGE_FRAGMENT_BIT },
                { 9, VK_DESCRIPTOR_TYPE_SAMPLER, 1, VK_SHADER_STAGE_FRAGMENT_BIT },
                { 10, VK_DESCRIPTOR_TYPE_SAMPLED_IMAGE, 1, VK_SHADER_STAGE_FRAGMENT_BIT },
