...
namespace NexAur {
    namespace {
        ...
        VulkanRenderView buildReflectionProbeCaptureView(
        ...
        glm::vec3 unprojectNdcPoint(const VulkanRenderView& view, const glm::vec3& ndc) {
    ...
    private:
        ...
        RenderPointShadowFrame buildPointShadowFrame(
            ...
            if (!render_settings.point_shadow.enabled || !point_shadow_target.isReady()) {
                return frame;
            }
