...
namespace NexAur {
    ...
    enum class RenderEffectDebugView : uint32_t {
        ...
        RayTracedReflectionRaw = 22,
        RayTracedReflectionConfidence = 23,
        RayTracedReflectionHitDistance = 24,
        RayTracedReflectionInstance = 25,
        RayTracedReflectionPrimitive = 26
    };
